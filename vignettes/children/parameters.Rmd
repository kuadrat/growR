...
- `irrigation` float. Should be non-negative but smaller than `WHC`. 
  Simulates irrigation by ensuring that water reserves `WR` never fall below 
  the here specified value. A value of `0` implies no irrigation.
